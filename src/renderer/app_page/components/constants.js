...
export const widthList = [
  { pen_width: 4,  highlighter_width: 8,  rainbow_pen_width: 2,  laser_width: [1.5, 4],  figure_size: 4,  icon_size: 12, name: 'extra_small', font_size: 21, font_y_offset_compensation: 3.5,   font_y_offset_compensation_retina: 3.5,   font_line_height_compensation: 2.625 },
